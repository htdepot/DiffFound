...
def init_distributed_mode(local_rank, args):
    ...
    #                         world_size=args.env.world_size, rank=args.env.rank, timeout=datetime.timedelta(seconds=3600))
    os.environ["MASTER_ADDR"] = "localhost"
    os.environ["MASTER_PORT"] = "12355"
    dist.init_process_group("nccl", rank=local_rank, world_size=args.env.world_size)
