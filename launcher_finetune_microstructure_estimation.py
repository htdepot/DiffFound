...
def update_pythonpath_relative_hydra():
    ...
    # NOTE: We do not change sys.path: we want to update paths for future8 instantiations
...
@hydra.main(config_path='configs_microstructure_estimation_finetune/', config_name='lmim')
def main(args):
    import omegaconf
