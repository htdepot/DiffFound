...
class DiffFound(nn.Module):
    ...
    def __init__(self, grid_size=14, patch_size=16, patch_gap=0, in_chans=30,
        ...
        self.ps_conv = Ps_Conv(in_channels=64, out_channels=30)
    ...
    def forward(self, imgs):
        ...
        dec0 = self.decoder1(dec1, convBlock)

        dec0 = self.transConv(dec0)
        logit = self.ps_conv(dec0).permute(0, 2, 3, 4, 1).contiguous()
